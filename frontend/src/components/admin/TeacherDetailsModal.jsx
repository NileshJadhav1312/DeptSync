               ...
               <div className="mt-8 pt-8 border-t border-slate-400">
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                     {[
                        ...
                        { label: "Journals", count: teacher.counts?.journals, color: "bg-indigo-50 text-indigo-700 border-indigo-100" },
                        { label: "Books", count: teacher.counts?.books, color: "bg-purple-50 text-purple-700 border-purple-100" },
                        { label: "Chapters", count: teacher.counts?.chapters, color: "bg-orange-50 text-orange-700 border-orange-100" },
                        ...
                        { label: "Patents", count: teacher.counts?.patents, color: "bg-purple-50 text-purple-700 border-purple-100" },
                        { label: "Copyrights", count: teacher.counts?.copyrights, color: "bg-rose-50 text-rose-700 border-rose-100" },
                        { label: "Conferences", count: teacher.counts?.conferences, color: "bg-orange-50 text-orange-700 border-orange-100" },
                        ...
                        ...(teacher.designation === "Class Teacher"
                           ? [{
                              label: "Classrooms",
                              count: teacher.counts?.classTeacher,
