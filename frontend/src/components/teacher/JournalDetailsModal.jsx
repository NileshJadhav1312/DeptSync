        ...
        <div className="p-6 overflow-y-auto space-y-4">
          <div className="grid grid-cols-2 gap-y-4 gap-x-6 text-sm">
            <div className="col-span-2">
              ...
              <span className="font-bold text-slate-900 text-base">{journal.paperTitle}</span>
            </div>
            <div>
            ...
            <div>
              ...
              <span className="font-semibold text-slate-900">{journal.publicationLevel}</span>
            </div>
            <div>
            ...
            <div>
              ...
              <span className="font-semibold text-slate-900">{journal.quartile || "N/A"}</span>
            </div>
            <div>
              <span className="block font-medium text-slate-500 uppercase tracking-wide text-xs">Volume / Issue</span>
              <span className="font-semibold text-slate-900">{journal.volume}{journal.issue ? ` / ${journal.issue}` : ""}</span>
            </div>
            <div>
              <span className="block font-medium text-slate-500 uppercase tracking-wide text-xs">Pages</span>
              <span className="font-semibold text-slate-900">{journal.pages || "N/A"}</span>
            </div>
            <div>
              <span className="block font-medium text-slate-500 uppercase tracking-wide text-xs">ISSN</span>
              <span className="font-semibold text-slate-900">{journal.issn || "N/A"}</span>
            </div>
            <div>
              <span className="block font-medium text-slate-500 uppercase tracking-wide text-xs">DOI / URL</span>
              <span className="font-semibold text-slate-900 truncate" title={journal.doi || journal.url}>
                {journal.doi || journal.url || "N/A"}
              </span>
            </div>
          </div>
