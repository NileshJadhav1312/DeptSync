...
export default function JournalPublicationFormModal({ isOpen, onClose, onSubmit, initialData }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 overflow-y-auto">
      ...
      <div className="relative w-full max-w-5xl bg-white rounded-3xl shadow-2xl flex flex-col my-8">
                   ...
                   <div className="flex items-center justify-between">
                     ...
                     {formData.cashIncentive && (
                        <div className="flex gap-4">
                           <input type="number" name="cashIncentiveAmount" value={formData.cashIncentiveAmount} onChange={handleChange} className="px-4 py-2 bg-white border border-slate-200 rounded-xl w-32 font-bold text-emerald-600" placeholder="Amount" />
                           <input name="vchBillNo" value={formData.vchBillNo} onChange={handleChange} className="px-4 py-2 bg-white border border-slate-200 rounded-xl w-40" placeholder="Bill/Vch No." />
                        </div>
                     )}
                   </div>
                </div>
