        ...
        <div className="p-6 overflow-y-auto space-y-4 text-sm">
          <div className="grid grid-cols-2 gap-y-4 gap-x-6">
            <div className="col-span-2">
              ...
              <span className="font-bold text-slate-900 text-base">{copyright.titleOfCopyright}</span>
            </div>
            <div>
            ...
            <div>
              ...
              <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-bold uppercase tracking-wide mt-1 w-fit ${
                  copyright.status === 'Registered' ? 'bg-emerald-100 text-emerald-700' : 'bg-blue-100 text-blue-700'
                }`}>
                  {copyright.status}
                </span>
            </div>
